 ...
 *           i.e., take the opposite sign of each element
 * Examples: If an element of arr has the value of -3, it would be set to 3
 *           If an element of arr has the value of 3, it would be set to -3
 */
